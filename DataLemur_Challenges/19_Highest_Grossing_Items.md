# DataLemur Challenge 19: Highest-Grossing Items

**Source:** [View challenge](https://datalemur.com/questions/sql-highest-grossing)
...
WITH high_gross_product AS (
  SELECT
    ...
    ROW_NUMBER()
      OVER(PARTITION BY category ORDER BY SUM(spend) DESC) AS rn
  FROM product_spend
